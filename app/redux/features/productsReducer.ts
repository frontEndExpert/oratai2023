...
import { createSlice, createAsyncThunk, isRejectedWithValue, ActionReducerMapBuilder } from "@reduxjs/toolkit";
...
export const productsReducer = createSlice({
  ...
  reducers: {
      ...
      updateCurrentProductId: (state, action) => {
        state.currentProductId = action.payload ;
      },
      updateCurrentProductGroup: (state, action) => {
        state.currentProductGroup = action.payload as unknown as Product[];
        state.loading = false;
      },
...
export const {add2AllOpen, add2AllClose, openProductPage, closeProductPage, openEdit, 
                ...
                changeLanguages, updateAllProducts, closeAdded, openAdded, setPathname, setgFormIsValid} = productsReducer.actions;
